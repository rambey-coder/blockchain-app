    ...
    <div className='w-screen bg-navcolor border-b-2 border-black py-3'>
        ...
        <div className='hidden md:flex items-center justify-between w-2/3'>
            ...
            <div className=' flex items-center justify-between '>
                <button className='border-2 border-white rounded p-2 mr-3 font-medium text-white'>Log In</button>
                <button className='bg-white rounded p-2 border-2 border-white text-navcolor font-semibold hover:bg-textcolor transition-all ease-linear'>Sign Up</button>
            </div>
        </div>
        ...
        <div className={nav ? 'w-screen bg-white text-navcolor absolute top-[96px]  opacity-100' : 'absolute opacity-0'}>
            <ul className='flex flex-col items-center justify-center'>
                <a><li className='font-xl font-semibold p-4'>Wallet</li></a>
                <a><li className='font-xl font-semibold p-4'>Exchange</li></a>
                <a><li className='font-xl font-semibold p-4'>Explorer</li></a>
                <a><li className='font-xl font-semibold p-4'>Institutional</li></a>

                <button className='border-2 border-textcolor rounded p-2  font-medium text-navcolor inline mb-9 w-3/4'>Log In</button>
                <button className='bg-white rounded p-2 border-2 border-textcolor text-navcolor font-semibold hover:bg-textcolor transition-all ease-linear inline mb-5 w-3/4'>Sign Up</button>
            </ul>
