...
const Navbar = () => {
  ...
  return (
    <div className='w-screen bg-navcolor py-4'>
        ...
        <div className={nav ? 'w-screen bg-white text-navcolor absolute top-[96px]  opacity-100' : 'absolute opacity-0'}>
            <ul className='flex flex-col items-center justify-center'>
                ...
                <button className='bg-white rounded p-2 border-2 border-text text-navcolor font-semibold hover:bg-textcolor transition-all ease-linear inline mb-5'>Sign Up</button>
            </ul>
